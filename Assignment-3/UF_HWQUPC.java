...
public class UF_HWQUPC implements UF {
    ...
    private static void countPrints(int i) {
        int conn = 0;
        int pairs = 0;
        ...
        while (u.components() != 1) {
            int a = (int) (rand.nextInt(i));
            int b = (int) (rand.nextInt(i));

            pairs++;

            if (u.connected(a, b) == false) {
                u.union(a, b);
                conn++;
            }

        }
        System.out.println("Number of sites: "+ i +" conn " + conn + " pair " + pairs );
    }

    public static void main(String[] args) {

//        Scanner scanner = new Scanner(System.in);
//        System.out.println("Input no. of sites:");
//        int i = scanner.nextInt();
        int[] inputArray = {500,1400,2300,3300,5500,6000};
        for(int i=0;i< inputArray.length;i++) {
            UF_HWQUPC u = new UF_HWQUPC(inputArray[i], true);
            countPrints(inputArray[i]);
        }
    }
